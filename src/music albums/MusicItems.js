    ...
    if (cartItemIndex === -1) {
      try {
        const res = await fetch(
          `https://crudcrud.com/api/d12832a7f6a34c318fbb53e28a8e5217/cartItem${userEmail}`,
          {
            method: "POST",
            body: JSON.stringify({
              title: product.title,
      ...
      try {
        await fetch(
          `https://crudcrud.com/api/d12832a7f6a34c318fbb53e28a8e5217/cartItem${userEmail}/${updatedItem[cartItemIndex]._id}`,
          {
            method: "PUT",
            body: JSON.stringify({
              title: product.title,
